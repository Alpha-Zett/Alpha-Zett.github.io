...
<body>
    ...
    <h1>
        <?php
        if($_SESSION['user']){
            echo '<a download="data.csv" href="./css/COVID19 Data 15102020.csv">You can download today’s data after logging in</a>';
        }else{
            echo '<a href="javascript:alert(\'Please log in and download the file\');">You can download today’s data after logging in</a>';
        }
        ?>
    </h1>
    <div class="map">
